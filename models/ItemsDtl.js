...
const _ItemsDtl = function(sequelize, DataTypes) {
  return sequelize.define('ItemsDtl', {
    UTD: {
      autoIncrement: true,
    ...
    indexes: [
      {
        name: "PK__ItemsDtl__C5B6F0D2C6757597",
        unique: true,
        fields: [
          { name: "UTD" },
        ]
...
const itemsDtlSchema = Joi.object({
...
module.exports = {_ItemsDtl , itemsDtlSchema};
